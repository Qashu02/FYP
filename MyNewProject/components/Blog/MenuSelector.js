...
const MenuSelector = ({ selectedPackage, setSelectedPackage, guestCount, setGuestCount, menuPackages }) => {
...
const styles = StyleSheet.create({
  ...
  total: { fontSize: 18, marginBottom: 5 },
  reservation: { fontSize: 16, color: '#555' },
